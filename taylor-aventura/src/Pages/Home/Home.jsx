...
function Home() {
  return (
    ...
    <div className='iconoHome'><img src="https://drive.google.com/uc?export=view&id=1HBiAhtsDJu_klfzelfCZJMndDwhAiSKs" alt="Icono elige tu propia aventura Taylor Swift" /></div>
